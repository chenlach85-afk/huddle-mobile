        ...
        {mode === "otp_verify" ? (
          <>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.85}
            >
              {loading ? <ActivityIndicator color={colors.primaryForeground} /> : <Text style={s.btnText}>Sign in</Text>}
            </TouchableOpacity>
          ...
          <>
            ...
            >
              {oauthLoading === "google" ? (
                ...
                <>
                  <Text style={{ fontSize: 16, color: colors.foreground, fontWeight: "700" }}>G</Text>
...
const styles = (colors: ReturnType<typeof useColors>) =>
  StyleSheet.create({
    ...
    btnText: { color: colors.primaryForeground, fontSize: 16, fontWeight: "700" },
